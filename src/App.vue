...
const showLocalePicker = computed(() => localeOptions.length > 1)
  ...
  <div class="site-shell">
    <header class="site-header">
      <RouterLink class="brand-lockup" to="/">
        ...
        <span class="brand-name">BATI</span>
      </RouterLink>

      <nav class="site-nav">
        <a href="https://github.com/ryujou/bati" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 4px; color: #333e49; font-weight: 600; text-decoration: none;" :title="t('app.nav.githubTitle')">
        ...
        <div v-if="showLocalePicker" class="lang-dropdown" :class="{ 'is-open': isLangOpen }" ref="langDropdownRef">
    ...
    <footer v-if="showFooter" class="site-footer">
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <a href="https://github.com/ryujou/bati" target="_blank" rel="noopener noreferrer" class="footer-link cta-star" style="display: inline-flex; align-items: center; gap: 6px; font-weight: 600; color: #3ba17c; margin-top: 4px;">
      ...
      <div class="footer-bottom">
        <p class="footer-copyright">© 2026 BATI Fan Project</p>
