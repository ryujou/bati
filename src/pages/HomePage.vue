  ...
  <div class="home">
    <section class="hero">
      <div class="container hero-inner">
        ...
        <div style="display: flex; gap: 16px; justify-content: center; align-items: center; margin-top: 2rem; flex-wrap: wrap;">
          ...
          <a href="https://github.com/ryujou/bati" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; font-size: 1.125rem; font-weight: 700; color: #fff; background: rgba(59, 161, 124, 0.9); padding: 0.8rem 2rem; border-radius: 50px; text-decoration: none; border: 2px solid transparent; transition: all 0.2s;">
    ...
    <section class="feature feature-light text-center" style="padding-top: 5rem; padding-bottom: 5rem;">
      <div class="container">
        ...
        <a href="https://github.com/ryujou/bati" target="_blank" rel="noopener noreferrer" class="btn btn-green" style="display: inline-flex; justify-content: center; align-items: center; gap: 0.5rem; max-width: 250px; margin: 0 auto;">
