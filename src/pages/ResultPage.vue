      ...
      <div class="result-hero-inner">
        <div class="hero-copy type-box">
          ...
          <div class="hero-actions">
            ...
            <a href="https://github.com/ryujou/bati" target="_blank" rel="noopener noreferrer" class="action-btn" style="background: rgba(255, 255, 255, 0.2); color: white; text-decoration: none; border: none;">
        ...
        <div class="hero-visual poster-box">
          <div class="poster-frame">
            <img
              v-if="primaryCharacterImage && !isCharacterImageBroken"
            ...
            <div
              ...
              :style="{ '--fallback-accent': primaryCharacter?.accent ?? result.archetype.accent }"
            >
              <span v-if="primaryCharacter" class="hero-image-badge">
                {{ getCharacterBadge(getLocalizedCharacterName(primaryCharacter, locale)) }}
              </span>
              <AppIcon v-else name="fallback" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="result-body">
      ...
      <aside class="result-sidebar">
        ...
        <div class="sidebar-card project-card">
          ...
          <a href="https://github.com/ryujou/bati" target="_blank" rel="noopener noreferrer" class="project-link" style="display: flex; align-items: center; justify-content: center; gap: 6px; background: #3ba17c; color: white; border-radius: 20px; padding: 6px 12px; font-weight: 600; text-decoration: none;">
...
.hero-image-fallback {
  ...
  aspect-ratio: 1;
  background:
    radial-gradient(circle at top right, color-mix(in srgb, var(--fallback-accent, #4aa3ff) 28%, white), transparent 38%),
    linear-gradient(145deg, color-mix(in srgb, var(--fallback-accent, #4aa3ff) 18%, white), color-mix(in srgb, var(--fallback-accent, #4aa3ff) 70%, #20344f));
  border-radius: 8px;
  display: flex;
  justify-content: center;
  align-items: center;
