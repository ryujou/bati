...
const acgtiPrimaryStylePath = path.join(repoRoot, 'public', 'images', 'characters', '后藤一里.png')
const acgtiSecondaryStylePath = path.join(repoRoot, 'public', 'images', 'characters', '御坂美琴.png')
